    ...
    <main className="min-h-screen bg-gray-50 flex justify-center items-start py-12 px-4">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 items-center">
          <h1 className="text-2xl font-bold text-gray-800">Skill Swap Requests</h1>
            ...
            filteredRequests.map((req) => (
              ...
              >
                ...
                <div className="flex flex-col items-center md:items-start gap-2 md:w-48 text-center md:text-left">
                  ...
                  />
                  <div className="text-sm text-gray-500">Rating: {req.rating}/5</div>
                </div>

                {/* Skills & Name */}
                <div className="flex-1 space-y-2">
                  <div className="font-semibold text-lg text-gray-800">{req.name}</div>
                  <div className="text-sm flex gap-2 flex-wrap">
                    <span className="text-green-700 font-medium">Skill Offered ⇒</span>
                    <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs">
                      {req.skillOffered}
                    </span>
                  </div>
                  <div className="text-sm flex gap-2 flex-wrap">
                    <span className="text-blue-700 font-medium">Skill Wanted ⇒</span>
